<?php
function teczilla_creative_inline_css(){
...
$teczilla_theme_color_scheme = get_theme_mod('teczilla_theme_color_scheme','#ff805d');               
...
add_action( 'wp_enqueue_scripts', 'teczilla_creative_inline_css',20 );

  function avadant_creative_custom_header_setup()
    {
        add_theme_support('custom-header', apply_filters('avadanta_custom_header_args', array(
            'default-image'          => get_stylesheet_directory_uri() . '/resources/images/header-bg.jpg',
            'default-text-color' => 'fff',
            'width'              => 1000,
            'height'             => 250,
            'flex-height'        => true,
            'wp-head-callback'   => 'avadanta_creative_header_style',
        )));
    }

    add_action( 'after_setup_theme', 'avadant_creative_custom_header_setup' );


if ( !function_exists('avadanta_creative_header_style') ) :
    /**
     * Add Header And background Images
     */
    function avadanta_creative_header_style()
    {
