...
elseif ( 'Teczilla' == $theme->name || 'Teczilla Consulting' == $theme->name || 'Teczilla Business' == $theme->name || 'Teczilla Agency' == $theme->name || 'Teczilla Corporate' == $theme->name || 'Teczilla startup' == $theme->name || 'Teczilla Finance' == $theme->name || 'Teczilla Dark' == $theme->name || 'Teczilla Creative' == $theme->name ){
...
if ( 'Teczilla Creative' == $theme->name ){
